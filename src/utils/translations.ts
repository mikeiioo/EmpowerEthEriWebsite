...
const translations = {
  en: {
    ...
    ourMissionDescription: 'EmpowerEthEri is a nonprofit mentorship program dedicated to connecting young Eritrean and Ethiopian people within the Metro Atlanta community to mentors who can guide them through college applications, career development, and navigating adulthood.',
    ...
    readyToGetInvolvedDescription: 'Whether you\'re looking for a mentor or want to share your knowledge with the next generation, we have a place for you in our community.',
    ...
    expandingHabeshaNetwork: 'Expanding the Habesha network',
    expandingHabeshaNetworkDesc: 'Building connections within the Habesha community to strengthen cultural bonds and professional relationships.',
    faqTitle: 'FAQ',
    faqQuestion1: 'What is EmpowerEthEri?',
    faqAnswer1: 'EmpowerEthEri is a mentorship program connecting Eritrean and Ethiopian youth with established older peers for guidance, support, and community building.',
    faqQuestion2: 'Who can join as a mentee?',
    faqAnswer2: 'Any young person of Eritrean or Ethiopian descent in high school who is looking for guidance in education, career, or cultural identity.',
